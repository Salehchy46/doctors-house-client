            ...
            <div className='hero-content lg:flex md:flex-row flex-col py-20'>
                ...
                <div className='flex-1 card m-6'>
                    ...
                    <div className='invisible md:visible flex justify-between'>
                        <button className='rounded-xl w-[170px] h-[80px] text-[18px] font-bold bg-[#F7A582]'>Cavity Protection</button>
                        <button className='rounded-xl w-[170px] h-[80px] text-[18px] font-bold bg-[#F7A582]'>Cavity Observation</button>
                        <button className='rounded-xl w-[170px] h-[80px] text-[18px] font-bold bg-[#F7A582]'>Oral Surgery</button>
                    </div>
