            ...
            <div className='hero-content lg:flex md:flex-row flex-col py-20'>
                ...
                <div className='flex-1'>
                    ...
                    <div className='invisible md:visible flex justify-between'>
                        <button className='rounded-xl w-[170px] h-[80px] text-[18px] font-bold bg-[#F7A582] hover:bg-transparent hover:border-2 hover:border-[#F7A582]'>Cavity Guard</button>
                        <button className='rounded-xl w-[170px] h-[80px] text-[18px] font-bold bg-[#F7A582] hover:bg-transparent hover:border-2 hover:border-[#F7A582]'>Cavity Outlook</button>
                        <button className='rounded-xl w-[170px] h-[80px] text-[18px] font-bold bg-[#F7A582] hover:bg-transparent hover:border-2 hover:border-[#F7A582]'>Oral Surgery</button>
                    </div>
